...
1. Open your browser and go to the [Georgia Power Outage Map](https://outagemap.georgiapower.com).
...
2. Place the docker-compose.yml, Dockerfile, requirements.txt, and app.py in the root of the folder.
3. Create the templates folder and put index.html inside it.
4. Point Dockhand to this directory, or just run docker compose up -d natively in your terminal.
5. Visit http://YOUR_VPS_IP:8080 in your browser.
